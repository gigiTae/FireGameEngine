...
#pragma warning(default : 4312)
	...
	_object = _factory->CreateObject(ObjectType::MeshObject, L"NULL", L"../ImpGraphicsEngine/FirstPassVS.hlsl", L"../ImpGraphicsEngine/FirstPassPS.hlsl"
		, L"../ImpGraphicsEngine/SecondPassVS.hlsl", L"../ImpGraphicsEngine/SecondPassPS.hlsl");
