...
std::filesystem::path ImpEngineModule::PathManager::GetWorldPath(const std::wstring& worldName)
{
...
std::vector<std::filesystem::path> ImpEngineModule::PathManager::GetDirectoryList(const std::filesystem::path& path)
{
	std::vector<std::filesystem::path> worldPaths;
...
std::vector<std::filesystem::path> ImpEngineModule::PathManager::GetLoadEntityList(const std::filesystem::path& worldPath)
{
...
std::vector<std::filesystem::path> ImpEngineModule::PathManager::GetStartEntityList(const std::filesystem::path& worldPath)
{
